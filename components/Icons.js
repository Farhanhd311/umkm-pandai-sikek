// Kumpulan ikon SVG inline agar tidak butuh dependency ikon eksternal.
// Semua menerima props standar (className, dll).
...
export function IconDirections(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M21.71 11.29l-9-9a1 1 0 00-1.42 0l-9 9a1 1 0 000 1.42l9 9a1 1 0 001.42 0l9-9a1 1 0 000-1.42Z" />
      <path d="M8 12h6M14 12l-2.5-2.5M14 12l-2.5 2.5" />
    </svg>
  );
}
